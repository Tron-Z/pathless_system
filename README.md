...
| [kernel](https://github.com/Tron-Z/kernel) | Orange Pi 内核 fork | `pathless-6.6-rk35xx` / `pathless-5.10-rk35xx` |
| [pathless-rockchip](https://github.com/Tron-Z/pathless-rockchip) | 瑞芯微 | `rkbin`、`rk35xx_packages`（每周自动同步上游） |
