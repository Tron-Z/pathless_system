...
| ---------- | :---------------------------- | --------------------------------- | -------- |
| 2026-06-15 | rk3576_busmcu_uart8_v1.05.bin | rt-thread:553c63b26f#hal:c3f4db36 | moderate |
...
| Date       | File                               | Build commit | Severity  |
| ---------- | :--------------------------------- | ------------ | --------- |
| 2026-06-15 | rk3576_scp_{uart4,uart8}_v1.16.bin | de81c73c     | important |

### New

1. Supports suspend/resume.
2. Supports configuring sleep state of RK806.
...
| Date       | File                  | Build commit | Severity  |
| ---------- | :-------------------- | ------------ | --------- |
| 2026-06-16 | rk3576_bl32_v1.12.bin | 72fc9ecd7    | important |

### New

1. Implement rk_platform_config_ip for gmac0.
2. Strictly match requested IPs against licence.

### Fixed

| Index | Severity  | Update Description                                           | Symptom                                | Bug Source |
| ----- | --------- | ------------------------------------------------------------ | -------------------------------------- | ---------- |
| 1     | important | Fix issue of expect_sn_len in crypto_service                 | Abnormal serial number length          | -          |
...
| Date       | File                  | Build commit | Severity  |
| ---------- | :-------------------- | ------------ | --------- |
| 2026-06-01 | rk3576_bl31_v1.25.elf | 73314437f | important |

### New

1. Support SIP_ACCESS_CPU_REG.
2. Adjust debug information for system sleep.
...
| Date | File | Build commit | Severity |
| ---- | :--- | ------------ | -------- |
| 2026-06-01 | rk3576_spl_v5_v1.00.bin | 0aa962ed3ab | important |
...
| Date       | File                        | Build commit | Severity |
| ---------- | :-------------------------- | ----------- | -------- |
| 2026-05-12 | rk3576_mos_vehicle_logo.bmp | 77bf67a44   | moderate  |

### New

1. Pre set logo data to designated memory.
...
| Date       | File                   | Build commit | Severity |
| ---------- | ---------------------- | ------------ | -------- |
| 2026-04-29 | rk3576_bl32_v1.11.bin | 5f256dc1a    | important |
...
| Date       | File                                                         | Build commit | Severity  |
| ---------- | :----------------------------------------------------------- | ------------ | --------- |
| 2026-04-29 | rk3576_ddr_lp4_2112MHz_lp5_2736MHz{_ultra,_eyescan,_mos,_ultra_mos}_v1.13.bin | e10b4dfeaf   | important |
...
| Date       | File                     | Build commit | Severity |
| ---------- | :----------------------- | ----------- | -------- |
| 2026-04-16 | rk3576_logo_raw_rgba.bin | 0ecf0e6a8   | moderate     |

### New

1. Supply the logo in RGBA format.
...
| Date       | File                               | Build commit | Severity |
| ---------- | :--------------------------------- | ----------- | -------- |
| 2026-03-12 | rk3576_scp_{uart4,uart8}_v1.15.bin | f4326952    | important     |

### New

1. RK806 support shut down voltage setting.
2. DCLK parent clks add bpll and lpll.
...
| Date       | File                   | Build Commit | Severity |
| ---------- | ---------------------- | ------------ | -------- |
| 2026-03-10 | rk3576_bl32_v1.10.bin | 14421695d    | important |

### New

1. Enable CFG_RK_FW_ENCRYPT_KEY.
...
| Date       | File                  | Build commit | Severity  |
| ---------- | :----------------------- | ----------- | -------- |
| 2026-03-02 | rk3576_spl_v1.09.bin | a27a89c5fa1   | important     |
...
## rk3576_bl31__{_primary,secondary}_v1.14.elf

| Date       | File                                        | Build commit | Severity  |
| ---------- | :------------------------------------------ | ------------ | --------- |
| 2026-02-12 | rk3576_bl31__{_primary,secondary}_v1.14.elf | 3c48d3cf6    | important |
...
## rk3576_bl31__{_primary,secondary}_v1.13.elf

| Date       | File                                        | Build commit | Severity  |
| ---------- | :------------------------------------------ | ------------ | --------- |
| 2026-01-05 | rk3576_bl31__{_primary,secondary}_v1.13.elf | 3a1b026b3    | important |

### New

1. Support RK3576J and RK3576M.
...
| Date       | File                  | Build commit | Severity  |
| ---------- | :-------------------- | ------------ | --------- |
| 2026-01-14 | rk3576_bl32_v1.09.bin | e72f39c70    | important |

### New

1. Add firmware enc/dec support.
2. Add DICE data read/write.

### Fixed

| Index | Severity  | Update                 | Issue description                                            | Issue source |
| ----- | --------- | ---------------------- | ------------------------------------------------------------ | ------------ |
| 1     | important | Fix OAEP compatibility | The certificates generated by the old OPTEE cannot be verified and resolved using the new OTPEE | 605128       |
