...
| ---------- | :----------------------- | ----------- | -------- |
| 2026-04-29 | rv1103b_tee_ta_v1.05.bin | 5f256dc1a   | 重要     |

### New

1. OAEP decode兼容MGF1 = SHA1。
2. 优化休眠唤醒。
...
| 时间       | 文件                     | 编译 commit | 重要程度 |
| ---------- | :----------------------- | ----------- | -------- |
| 2026-03-02 | rv1103b_spl_v1.01.bin | a27a89c5fa1 | 重要     |
...
| 时间       | 文件                               | 编译 commit                                    | 重要程度 |
| ---------- | :--------------------------------- | ---------------------------------------------- | -------- |
| 2026-02-10 | rv1103b_usbplug_auto_merge_v1.11.bin | 3bb9568b5 | 普通     |
...
| 时间       | 文件                              | 编译 commit | 重要程度 |
| ---------- | :-------------------------------- | ----------- | -------- |
| 2025-10-10 | rv1103b_ddr_924MHz{_tb}_v1.06.bin | b971cce143  | 重要     |

### New

1. 为UART0M0的RX引脚添加弱上拉，防止其误切到JTAG模式。
2. 添加rzq校准功能。
...
| Index | 重要程度 | 更新说明                  | 问题现象                          | 问题来源 |
| ----- | -------- | ------------------------- | --------------------------------- | -------- |
| 1     | 重要     | 修复DDR初始化卡死问题     | PLL电源纹波大的板子概率性开机卡死 | -        |
| 2     | 重要     | 修复gate training异常问题 | 概率性training结果异常卡死        | -        |
