...
## rk3568_bl32_v2.18.bin

| Date       | File                   | Build commit | Severity |
| ---------- | ---------------------- | ------------ | -------- |
| 2026-04-29 | rk3568_bl32_v2.18.bin | 5f256dc1a    | important |
...
## rk3568_bl31_l3_part_ecc_v1.02.elf

| Date       | File                              | Build commit | Severity  |
| ---------- | :-------------------------------- | ------------ | --------- |
| 2026-04-29 | rk3568_bl31_l3_part_ecc_v1.02.elf | f404f8a03    | important |

### New

1. Update version to match rk3568_bl31_v1.46.elf.

------

## rk3568_bl32_v2.17.bin

| Date       | File                   | Build Commit | Severity |
| ---------- | ---------------------- | ------------ | -------- |
| 2026-03-10 | rk3568_bl32_v2.17.bin | 14421695d    | important |
...
## rk3568_ddr_{1560...1056}MHz_v1.25.bin

| Date       | File                                  | Build commit | Severity  |
| ---------- | ------------------------------------- | ------------ | --------- |
| 2025-12-03 | rk3568_ddr_{1560...1056}MHz_v1.25.bin | 5b48980fd7   | important |

### New

Support disabling RZQI check through dddbin_tool.

### Fixed

| Index | Severity  | Update                                      | Issue description         | Issue source |
| ----- | --------- | ------------------------------------------- | ------------------------- | ------------ |
| 1     | important | Support 4rank cs0/2_row > cs1/3_row LPDDR4. | Capacity detection error. | -            |
| 2     | important | Fix 2cs 64 bit LPDDR4 compatibility issue.  | DDR type detection error. | -            |

------

## rk3568_bl31_v1.46.elf

| Date       | File                  | Build commit | Severity |
| ---------- | --------------------- | ------------ | -------- |
| 2025-09-20 | rk3568_bl31_v1.46.elf | 0a207bf3c    | moderate |

### Fixed

| Index | Severity | Update                                                       | Issue description                                            | Issue source |
| ----- | -------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------ |
| 1     | moderate | Fix the issue where the dmcinfo interface cannot obtain capacity and manufacturer ID. | The dmcinfo interface is unable to obtain the capacity and manufacturer ID. | -            |
...
| Date       | File                                  | Build commit | Severity  |
| ---------- | ------------------------------------- | ------------ | --------- |
| 2025-08-18 | rk3568_ddr_{1560...1056}MHz_v1.24.bin | 22cad52210   | important |
...
| 2     | important | Fix the incompatibility issue of the DQ map for 6x16 DDR4 ECC board. | Error occurred during DDR initialization training.           | -            |
...
| Date       | File                  | Build commit | Severity  |
| ---------- | :-------------------- | ------------ | --------- |
| 2025-07-01 | rk3568_bl32_v2.16.bin | 3864e29ae    | important |
...
| Date       | File                              | Build commit | Severity |
| ---------- | --------------------------------- | ------------ | -------- |
| 2025-06-24 | rk3568_bl31_l3_part_ecc_v1.01.elf | 9ece6a9f7    | moderate |

### New

1. Synchronize to rk3568_bl31_v1.45.elf.
