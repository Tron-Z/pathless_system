...
## rv1106_tee_ta_v1.14.bin

| Date       | File                    | Build commit | Severity  |
| ---------- | :---------------------- | ------------ | --------- |
| 2026-04-29 | rv1106_tee_ta_v1.14.bin | 5f256dc1a    | important |
...
| 2     | important | Merge official security patches                          | Address potential security risks                             | -            |
| 3     | important | Fix the low-probability data abort issue                 | The reboot of the device during secure storage may trigger it with a low probability | -            |

------

## rv1106_usbplug_automerge_v1.09.bin

| Date       | File                     | Build commit | Severity  |
| ---------- | :----------------------- | ------------ | --------- |
| 2026-03-30 | rv1106_usbplug_automerge_v1.09.bin | 2adf11367    | moderate |

### New

1. Support spinor dual flash auto_merge.

------

## rv1106_hpmcu_wrap_v2.03rc4.bin

| Date      | File                        | Build commit                     | Severity |
| --------- | :-------------------------- | ------------------------------- | -------- |
| 2026-03-12 | rv1106_hpmcu_wrap_v2.03rc4.bin | rockit_ko:3c41cf1#hal:1f67b1b4 | important     |

### Fixed

| Index | Severity  | Update                                      | Issue description                                   | Issue source |
| ----- | --------- | ------------------------------------------- | --------------------------------------------------- | ------------ |
| 1     | important | Fix MCU idle reconfiguration-free start fail | MCU fails to start again without reconfiguration after idle | - |
| 2     | important | Fix MCU start fail                           | MCU start fail                                      | - |
| 3     | important | Fix avs flag not resumed after suspend       | AVS flag not resumed after resume from suspend status | - |
| 4     | important | Fix avs wrap bug                             | AVS wrap function abnormal                          | - |
| 5     | important | Add avs wrap function support                | Missing AVS wrap function support                   | - |
| 6     | important | Fix simple sensor wrap fail                  | Simple sensor wrap fail                             | - |

------

## rv1106_spl_v1.03.bin

| Date       | File                  | Build commit | Severity  |
| ---------- | :----------------------- | ----------- | -------- |
| 2026-03-02 | rv1106_spl_v1.03.bin | a27a89c5fa1   | important     |
