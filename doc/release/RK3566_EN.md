...
## rk3566_ddr_{1056...920}MHz_v1.26.bin

| Date       | File                                 | Build commit | Severity  |
| ---------- | ------------------------------------ | ------------ | --------- |
| 2026-05-21 | rk3566_ddr_{1056...920}MHz_v1.26.bin | 1e5d6e92ad   | important |

### New

1. Support single channel LPDDR4/LPDDR4X drams.

### Fixed

| Index | Severity  | Update                                                                       | Issue description               | Issue source |
| ----- | --------- | ---------------------------------------------------------------------------- | ------------------------------- | ------------ |
| 1     | important | Fix the bug of abnormal startup probability.                                 | Capacity detection error.       | -            |
| 2     | important | Fix the issue where larger tdqs2dq drams cause the ddr bin to report errors. | Enhance software compatibility. | -            |

------

## rk3568_ddr_{1056...920}MHz_v1.25.bin

| Date       | File                                 | Build commit | Severity  |
| ---------- | ------------------------------------ | ------------ | --------- |
| 2025-12-03 | rk3568_ddr_{1056...920}MHz_v1.25.bin | 5b48980fd7   | important |
...
## rk3566_ddr_{1056...920}MHz_v1.24.bin

| Date       | File                                 | Build commit | Severity  |
| ---------- | ------------------------------------ | ------------ | --------- |
| 2025-08-18 | rk3566_ddr_{1056...920}MHz_v1.24.bin | 22cad52210   | important |
