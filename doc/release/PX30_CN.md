...
| ---- | :--- | ----------- | -------- |
| 2026-06-03 | px30_bl31_v1.36.elf | 9ce22f446 | 重要 |
...
| 时间       | 文件                | 编译 commit | 重要程度 |
| ---------- | :------------------ | ----------- | -------- |
| 2026-04-29 | px30_bl32_v2.21.bin | 5f256dc1a   | 重要     |
...
| 时间       | 文件                  | 编译 commit | 重要程度 |
| ---------- | :-------------------- | ----------- | -------- |
| 2026-03-10 | px30_bl32_v2.20.bin | 14421695d   | 重要     |
...
3. 支持DICE数据读写。
5. 支持kt_cipher_mac和rk_oem_otp_key_aead。
5. 支持user ta cipher。
6. 支持rk_verify_config_ip。
...
| 2     | 重要     | 掉电导致 ta_ver.db 数据不完整问题 | ldelf_init_with_ldelf:126 ldelf failed with res: 0xffff0007 | 613634   |
...
| 时间       | 文件                  | 编译 commit | 重要程度 |
| ---------- | :-------------------- | ----------- | -------- |
| 2026-02-12 | px30_bl31_v1.35.elf | afdac37e9 | 重要 |
...
| 时间       | 文件                      | 编译 commit | 重要程度 |
| ---------- | ------------------------- | ----------- | -------- |
| 2025-09-11 | px30_ddr_333MHz_v2.12.bin | e8ca401     | 重要     |
