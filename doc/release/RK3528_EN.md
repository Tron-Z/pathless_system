...
## rk3528_ddr_1056MHz_{2L_PCB,4BIT_PCB}_{D3_LP3,D4,LP4_4x_eyescan}_v1.14.bin

| Date       | File                                                         | Build commit | Severity  |
| ---------- | ------------------------------------------------------------ | ------------ | --------- |
| 2026-03-19 | rk3528_ddr_1056MHz_{2L_PCB,4BIT_PCB}_{D3_LP3,D4,LP4_4x_eyescan}_v1.14.bin | c097eb3447   | important |

### New

1. Support DDR3 for RK3528.

------

## rk3528_bl32_v1.07.bin

| Date       | File                   | Build Commit | Severity |
| ---------- | ---------------------- | ------------ | -------- |
| 2026-03-10 | rk3528_bl32_v1.07.bin  | 14421695d    | important |
...
## rk3528_spl_v1.07.bin

| Date       | File                  | Build commit | Severity  |
| ---------- | :----------------------- | ----------- | -------- |
| 2026-03-02 | rk3528_spl_v1.07.bin | a27a89c5fa1   | important     |
...
## rk3528_ddr_1056MHz_{2L_PCB,4BIT_PCB}_{D3_LP3,D4,LP4_4x_eyescan}_v1.13.bin

| Date       | File                                                         | Build commit | Severity  |
| ---------- | ------------------------------------------------------------ | ------------ | --------- |
| 2025-12-03 | rk3528_ddr_1056MHz_{2L_PCB,4BIT_PCB}_{D3_LP3,D4,LP4_4x_eyescan}_v1.13.bin | 3d08567393   | important |

### New

1. Add the ZQ check control bit to the ddrbin parameter.
