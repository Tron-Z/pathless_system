...
cp "${EXTER}"/packages/blobs/desktop/wallpapers/pathless*.jpg "${destination}"/usr/share/backgrounds/gnome/
...
<wallpapers>
  <wallpaper deleted="false">
    ...
    <filename>/usr/share/backgrounds/gnome/pathless18-Dre0x-Minum-light-3840x2160.jpg</filename>
  ...
  <wallpaper deleted="false">
    ...
    <filename>/usr/share/backgrounds/gnome/pathless03-Dre0x-Minum-dark-3840x2160.jpg</filename>
    <options>zoom</options>
    <pcolor>#ffffff</pcolor>
    <scolor>#000000</scolor>
  </wallpaper>
