...
if ext4load mmc ${boot_part} ${load_addr} /boot/pathlessEnv.txt || fatload mmc ${boot_part} ${load_addr} pathlessEnv.txt || ext4load mmc ${boot_part} ${load_addr} pathlessEnv.txt; then
