...
#
# Please edit /boot/pathlessEnv.txt to set supported parameters
#
...
if test -e ${devtype} ${devnum} ${prefix}pathlessEnv.txt; then
	load ${devtype} ${devnum} ${load_addr} ${prefix}pathlessEnv.txt
	env import -t ${load_addr} ${filesize}
fi

if test "${console}" = "display" || test "${console}" = "both"; then setenv consoleargs "console=ttyS0,115200 console=tty1"; fi
if test "${console}" = "serial"; then setenv consoleargs "console=ttyS0,115200"; fi
if test "${bootlogo}" = "true"; then setenv consoleargs "bootsplash.bootfile=bootsplash.pathless ${consoleargs}"; fi
...
# Pathless 3 without eMMC needs to turn off sdc2
