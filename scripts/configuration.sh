...
[[ -z $VENDOR ]] && VENDOR="Pathless"
[[ -z $ROOTPWD ]] && ROOTPWD="pathless" # Must be changed @first login
[[ -z $PL_USERNAME ]] && PL_USERNAME="pathless" 
[[ -z $PL_PWD ]] && PL_PWD="pathless" 
[[ -z $MAINTAINER ]] && MAINTAINER="Pathless" # deb signature
